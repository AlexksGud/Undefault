...
/// <summary>
/// Host-side wrapper that records game-triggered playback commands without changing Core contracts.
/// </summary>
public sealed class RecordingMusicPlaybackControl : IMusicPlaybackControl
{
    private readonly IMusicPlaybackControl _inner;
    private readonly MusicLastCommandStore _store;
    private readonly IOptions<SmtcOptions> _smtcOptions;

    /// <summary>
    /// Initializes a new instance of the <see cref="RecordingMusicPlaybackControl"/> class.
    /// </summary>
    /// <param name="inner">The session coordinator that applies commands.</param>
    /// <param name="store">The last-command recorder.</param>
    /// <param name="smtcOptions">The selected SMTC id binding.</param>
    public RecordingMusicPlaybackControl(
        IMusicPlaybackControl inner,
        MusicLastCommandStore store,
